...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var ApiCategoryService = /** @class */ (function () {
            function ApiCategoryService(httpClient) {
                this.httpClient = httpClient;
                this.path = '/api/v1/category';
            }

            ApiCategoryService.prototype.getHints = function () {
                return this.httpClient.get(this.path);
            };
            ApiCategoryService.prototype.save = function (categoryParameters) {
                return this.httpClient.post(this.path, categoryParameters);
            };
            ApiCategoryService.prototype.remove = function (id) {
                return this.httpClient.delete(this.path + "/" + id);
            };
            return ApiCategoryService;
        }());
        ApiCategoryService.ctorParameters = function () {
            return [
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
        var ApiHintService = /** @class */ (function () {
            function ApiHintService(httpClient) {
                this.httpClient = httpClient;
                this.path = '/api/v1/hint';
            }

            ApiHintService.prototype.getHints = function () {
                return this.httpClient.get(this.path);
            };
            ApiHintService.prototype.saveHint = function (hintParameters, imageUrl) {
                return this.httpClient.post(this.path, Object.assign({}, hintParameters, {imgUrl: imageUrl}));
            };
            ApiHintService.prototype.remove = function (id) {
                return this.httpClient.delete(this.path + "/" + id);
            };
            return ApiHintService;
        }());
        ApiHintService.ctorParameters = function () {
            return [
                {type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var ApiImageService = /** @class */ (function () {
            function ApiImageService(httpClient) {
                this.httpClient = httpClient;
                this.path = '/api/v1/image';
            }

            ApiImageService.prototype.uploadImage = function (file) {
        ...
        ApiImageService.ctorParameters = function () {
            return [
                {type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
        var ApiPointService = /** @class */ (function () {
            function ApiPointService(httpClient) {
                this.httpClient = httpClient;
                this.path = '/api/v1/point';
            }

            ApiPointService.prototype.getPoints = function () {
                return this.httpClient.get(this.path);
            };
            ApiPointService.prototype.save = function (pointParameters, imgUrl) {
                return this.httpClient.post(this.path, Object.assign({}, pointParameters, {imgUrlList: [imgUrl]}));
            };
            ApiPointService.prototype.remove = function (id) {
                return this.httpClient.delete(this.path + "/" + id);
            };
            return ApiPointService;
        }());
        ApiPointService.ctorParameters = function () {
            return [
                {type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
        var ApiTravelService = /** @class */ (function () {
            function ApiTravelService(httpClient) {
                this.httpClient = httpClient;
                this.path = '/api/v1/travel';
            }

            ApiTravelService.prototype.getTravels = function () {
                return this.httpClient.get(this.path);
            };
            ApiTravelService.prototype.save = function (travelParameters, imageUrl) {
                return this.httpClient.post(this.path, Object.assign({}, travelParameters, {imgUrl: imageUrl}));
            };
            ApiTravelService.prototype.remove = function (id) {
                return this.httpClient.delete(this.path + "/" + id);
            };
            return ApiTravelService;
        }());
        ApiTravelService.ctorParameters = function () {
            return [
                {type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function generateMockTravelList(numberOfItems) {
            return Array.from(Array(numberOfItems), function (value, index) {
                return ({
                    id: index,
                    name: "Travel " + (index + 1),
                    adminId: 1,
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AdminPanelLayoutContainerComponent = /** @class */ (function () {
            function AdminPanelLayoutContainerComponent(store) {
                this.store = store;
        ...
        AdminPanelLayoutContainerComponent.ctorParameters = function () {
            return [
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var globalReducer = {
            app: Object(reduce_reducers__WEBPACK_IMPORTED_MODULE_1__["default"]).apply(void 0, reducers),
        };
        /***/
    }),
    /***/
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var ResetUserAction = /** @class */ (function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var LoginComponent = /** @class */ (function () {
            ...
            LoginComponent.prototype.handleChangeLogin = function (value) {
                this.changeLogin.emit(value);
            };
            LoginComponent.prototype.handleChangePassword = function (value) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var LoginContainerComponent = /** @class */ (function () {
            function LoginContainerComponent(store, router) {
                this.store = store;
                this.router = router;
            ...
            LoginContainerComponent.prototype.handleChangeLogin = function (value) {
                this.loginParameters = Object.assign({}, this.loginParameters, {login: value});
            };
            LoginContainerComponent.prototype.handleChangePassword = function (value) {
        ...
        LoginContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]},
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function authReducer(state, action) {
            if (state === void 0) {
                state = _app_common_initialState__WEBPACK_IMPORTED_MODULE_1__["initialState"];
            }
            switch (action.type) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var getLoginUserState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_getUser__WEBPACK_IMPORTED_MODULE_2__["getUser"], function (user) {
            return Boolean(user);
        });
        /***/
    }),
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var getUser = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__["getAppState"], function (state) {
            return state.user;
        });
        /***/
    }),
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var AddCategoryAction = /** @class */ (function () {
            function AddCategoryAction(category) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectLoadCategoriesAction = /** @class */ (function () {
            function RejectLoadCategoriesAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectRemoveCategoryAction = /** @class */ (function () {
            function RejectRemoveCategoryAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectSaveCategoryAction = /** @class */ (function () {
            function RejectSaveCategoryAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RemoveCategoryAction = /** @class */ (function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var SaveCategoryAction = /** @class */ (function () {
            function SaveCategoryAction(parameters) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var SetCategoriesAction = /** @class */ (function () {
            function SetCategoriesAction(categories) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var TryToRemoveCategoryAction = /** @class */ (function () {
            function TryToRemoveCategoryAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddCategoryComponent = /** @class */ (function () {
            ...
            AddCategoryComponent.prototype.handleChangeName = function (value) {
                this.changePointParameters.emit(Object.assign({}, this.addCategoryParameters, {name: value}));
            };
            AddCategoryComponent.prototype.handleChangeFile = function (file) {
                this.changePointParameters.emit(Object.assign({}, this.addCategoryParameters, {imgUrl: file.name}));
            };
            AddCategoryComponent.prototype.handleCreate = function () {
                this.create.emit();
            };
            return AddCategoryComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var CategoryListItemComponent = /** @class */ (function () {
            ...
            CategoryListItemComponent.prototype.handleRemove = function () {
                this.remove.emit();
            };
            return CategoryListItemComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddCategoryContainerComponent = /** @class */ (function () {
            function AddCategoryContainerComponent(store) {
                this.store = store;
            ...
            AddCategoryContainerComponent.prototype.handleChangeCategoryParameters = function (value) {
                this.addCategoryParameters = value;
            };
            AddCategoryContainerComponent.prototype.handleCreate = function () {
        ...
        AddCategoryContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var CategoryListContainerComponent = /** @class */ (function () {
            function CategoryListContainerComponent(store) {
                this.store = store;
            ...
            CategoryListContainerComponent.prototype.handleRemove = function (id) {
                this.store.dispatch(new _actions_TryToRemoveCategoryAction__WEBPACK_IMPORTED_MODULE_5__["TryToRemoveCategoryAction"](id));
            };
            return CategoryListContainerComponent;
        }());
        CategoryListContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var CategoryEffects = /** @class */ (function () {
            function CategoryEffects(actions$, apiEndpointCategoryService, notificationService) {
                var _this = this;
                this.actions$ = actions$;
                this.apiEndpointCategoryService = apiEndpointCategoryService;
                this.notificationService = notificationService;
                this.loadCategories$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_LoadCategoriesAction__WEBPACK_IMPORTED_MODULE_5__["LoadCategoriesAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function () {
                        return _this.apiEndpointCategoryService.getHints().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (categories) {
                            return new _actions_SetCategoriesAction__WEBPACK_IMPORTED_MODULE_8__["SetCategoriesAction"](categories);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function () {
                            _this.notificationService.error('Failed to load categories');
                ...
                this.saveCategory$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_SaveCategoryAction__WEBPACK_IMPORTED_MODULE_13__["SaveCategoryAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (action) {
                        return _this.apiEndpointCategoryService.save(action.parameters).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (category) {
                            _this.notificationService.success('Category successfully added');
                            return new _actions_AddCategoryAction__WEBPACK_IMPORTED_MODULE_14__["AddCategoryAction"](category);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function () {
                            _this.notificationService.error('Failed to save category');
                ...
                this.removeCategories$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_TryToRemoveCategoryAction__WEBPACK_IMPORTED_MODULE_10__["TryToRemoveCategoryAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (action) {
                        return _this.apiEndpointCategoryService.remove(action.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function () {
                            return new _actions_RemoveCategoryAction__WEBPACK_IMPORTED_MODULE_11__["RemoveCategoryAction"](action.id);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function () {
                            _this.notificationService.error('Failed to remove category');
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function categoryReducer(state, action) {
            ...
            switch (action.type) {
                ...
                case _actions_RemoveCategoryAction__WEBPACK_IMPORTED_MODULE_3__["RemoveCategoryAction"].type:
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/selectors/getAppState */ "./src/modules/app/selectors/getAppState.ts");
        var getCategories = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__["getAppState"], function (state) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var AddHintAction = /** @class */ (function () {
            function AddHintAction(hint) {
                this.hint = hint;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var LoadHintsAction = /** @class */ (function () {
            function LoadHintsAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectLoadHintsAction = /** @class */ (function () {
            function RejectLoadHintsAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectRemoveHintAction = /** @class */ (function () {
            function RejectRemoveHintAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectSaveHintAction = /** @class */ (function () {
            function RejectSaveHintAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RemoveHintAction = /** @class */ (function () {
            function RemoveHintAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SaveHintAction = /** @class */ (function () {
            function SaveHintAction(parameters) {
                this.parameters = parameters;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SetHintsAction = /** @class */ (function () {
            function SetHintsAction(hints) {
                this.hints = hints;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var TryToRemoveHintAction = /** @class */ (function () {
            function TryToRemoveHintAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
        var AddHintComponent = /** @class */ (function () {
            function AddHintComponent() {
                this.changePointParameters = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                this.create = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
            }

            AddHintComponent.prototype.handleChangeName = function (value) {
                this.changePointParameters.emit(Object.assign({}, this.hintParameters, {name: value}));
            };
            AddHintComponent.prototype.handleChangeShortDescription = function (event) {
                var element = event.target;
                this.changePointParameters.emit(Object.assign({}, this.hintParameters, {shortDescription: element.value}));
            };
            AddHintComponent.prototype.handleChangeDescription = function (event) {
                var element = event.target;
                this.changePointParameters.emit(Object.assign({}, this.hintParameters, {description: element.value}));
            };
            AddHintComponent.prototype.handleChangeFile = function (file) {
                this.changePointParameters.emit(Object.assign({}, this.hintParameters, {imgFiles: [file]}));
            };
            AddHintComponent.prototype.handleCreate = function () {
                this.create.emit();
            };
            return AddHintComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
        var HintListItemComponent = /** @class */ (function () {
            function HintListItemComponent() {
                this.remove = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
            }

            HintListItemComponent.prototype.handleRemove = function () {
                this.remove.emit();
            };
            return HintListItemComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddHintParametersContainerComponent = /** @class */ (function () {
            function AddHintParametersContainerComponent(store) {
                this.store = store;
                this.hintParameters = {
                    name: '',
                    description: '',
            ...
            AddHintParametersContainerComponent.prototype.handleChangePointParameters = function (value) {
                this.hintParameters = value;
            };
            AddHintParametersContainerComponent.prototype.handleCreate = function () {
                this.store.dispatch(new _actions_SaveHintAction__WEBPACK_IMPORTED_MODULE_4__["SaveHintAction"](this.hintParameters));
            };
            return AddHintParametersContainerComponent;
        }());
        AddHintParametersContainerComponent.ctorParameters = function () {
            return [
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var HintListContainerComponent = /** @class */ (function () {
            function HintListContainerComponent(store) {
                this.store = store;
            ...
            HintListContainerComponent.prototype.handleRemove = function (id) {
                this.store.dispatch(new _actions_TryToRemoveHintAction__WEBPACK_IMPORTED_MODULE_5__["TryToRemoveHintAction"](id));
            };
            return HintListContainerComponent;
        }());
        HintListContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var HintEffects = /** @class */ (function () {
            function HintEffects(actions$, apiHintEndpointService, notifivationService) {
                var _this = this;
                this.actions$ = actions$;
                this.apiHintEndpointService = apiHintEndpointService;
                this.notifivationService = notifivationService;
                this.loadHints$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_LoadHintsAction__WEBPACK_IMPORTED_MODULE_4__["LoadHintsAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
                        return _this.apiHintEndpointService.getHints().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (hints) {
                            return new _actions_SetHintsAction__WEBPACK_IMPORTED_MODULE_6__["SetHintsAction"](hints);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
                            _this.notifivationService.error('Failed to load hints');
                ...
                this.addHint$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_SaveHintAction__WEBPACK_IMPORTED_MODULE_13__["SaveHintAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (action) {
                        return _this.apiHintEndpointService
                            .saveHint(action.parameters, '')
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (hint) {
                                _this.notifivationService.success('Hint successfully added');
                                return new _actions_AddHintAction__WEBPACK_IMPORTED_MODULE_14__["AddHintAction"](hint);
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
                                _this.notifivationService.error('Failed to add hint');
                ...
                this.removeHint$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_TryToRemoveHintAction__WEBPACK_IMPORTED_MODULE_10__["TryToRemoveHintAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (action) {
                        return _this.apiHintEndpointService.remove(action.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
                            return new _actions_RemoveHintAction__WEBPACK_IMPORTED_MODULE_11__["RemoveHintAction"](action.id);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
                            _this.notifivationService.error('Failed to remove hint');
        ...
        HintEffects.ctorParameters = function () {
            return [
                {type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"]},
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var HintsModule = /** @class */ (function () {
            function HintsModule() {
            }
        ...
        function hintReducer(state, action) {
            ...
            switch (action.type) {
                ...
                case _actions_AddHintAction__WEBPACK_IMPORTED_MODULE_4__["AddHintAction"].type:
                    return Object.assign({}, state, {hints: state.hints.concat([action.hint])});
                case _actions_RemoveHintAction__WEBPACK_IMPORTED_MODULE_2__["RemoveHintAction"].type:
                    return Object.assign({}, state, {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/selectors/getAppState */ "./src/modules/app/selectors/getAppState.ts");
        var getHints = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__["getAppState"], function (state) {
            return state.hints;
        });
        /***/
    }),
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
        var UploadIconComponent = /** @class */ (function () {
            function UploadIconComponent() {
            }
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var NavigationComponent = /** @class */ (function () {
            ...
            NavigationComponent.prototype.handleSelect = function (tab) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var NavigationContainerComponent = /** @class */ (function () {
            function NavigationContainerComponent(store) {
                this.store = store;
            ...
            NavigationContainerComponent.prototype.handleChangeTab = function (tab) {
                this.store.dispatch(new _actions_SetActiveTab__WEBPACK_IMPORTED_MODULE_4__["SetActiveTab"](tab));
            };
            return NavigationContainerComponent;
        }());
        NavigationContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/selectors/getAppState */ "./src/modules/app/selectors/getAppState.ts");
        var getActiveTab = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__["getAppState"], function (state) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var ErrorNotificationComponent = /** @class */ (function () {
            function ErrorNotificationComponent() {
                this.message = '';
                this.hidden = false;
            }

            ErrorNotificationComponent.prototype.handleClose = function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/animations */ "./node_modules/@angular/animations/fesm2015/animations.js");
        var SuccessNotificationComponent = /** @class */ (function () {
            function SuccessNotificationComponent() {
                this.message = '';
                this.hidden = false;
            }

            SuccessNotificationComponent.prototype.handleClose = function () {
                this.notificationService.detachComponent(this);
            };
            return SuccessNotificationComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var NotificationContainerComponent = /** @class */ (function () {
            function NotificationContainerComponent(notificationService) {
                this.notificationService = notificationService;
            }

            NotificationContainerComponent.prototype.ngAfterContentInit = function () {
                this.notificationService.setElementRef(this.notificationContainer);
            };
            return NotificationContainerComponent;
        }());
        NotificationContainerComponent.ctorParameters = function () {
            return [
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
        var NotificationHostDirective = /** @class */ (function () {
            function NotificationHostDirective(viewContainerRef) {
                this.viewContainerRef = viewContainerRef;
            }

            return NotificationHostDirective;
        }());
        NotificationHostDirective.ctorParameters = function () {
            return [
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var NotificationService = /** @class */ (function () {
            function NotificationService(componentFactoryResolver) {
            ...
            NotificationService.prototype.attachComponent = function (component, message) {
                var _this = this;
                var componentFactory = this.componentFactoryResolver.resolveComponentFactory(component);
                var viewContainerRef = this.notificationContainer.viewContainerRef;
                var componentRef = viewContainerRef.createComponent(componentFactory);
                var notificationComponent = componentRef.instance;
                notificationComponent.message = message;
                notificationComponent.notificationService = this;
                this.notifications = this.notifications.concat([notificationComponent]);
                setTimeout(function () {
                ...
                setTimeout(function () {
                    return _this.detachComponent(notificationComponent);
                }, _common_notificationConfig__WEBPACK_IMPORTED_MODULE_4__["notificationConfig"].lifetime);
            };
            NotificationService.prototype.detachComponent = function (notification) {
            ...
            NotificationService.prototype.setElementRef = function (hostElement) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var AddPointAction = /** @class */ (function () {
            function AddPointAction(point) {
                this.point = point;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var LoadPointsAction = /** @class */ (function () {
            function LoadPointsAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectLoadPointsAction = /** @class */ (function () {
            function RejectLoadPointsAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectRemovePointAction = /** @class */ (function () {
            function RejectRemovePointAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectSavePointAction = /** @class */ (function () {
            function RejectSavePointAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RemovePointAction = /** @class */ (function () {
            function RemovePointAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SavePointAction = /** @class */ (function () {
            function SavePointAction(point) {
                this.point = point;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SavePointImageFulFillAction = /** @class */ (function () {
            function SavePointImageFulFillAction(payload) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SetPointsAction = /** @class */ (function () {
            function SetPointsAction(points) {
                this.points = points;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var TryToRemovePointAction = /** @class */ (function () {
            function TryToRemovePointAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddPointComponent = /** @class */ (function () {
            ...
            Object.defineProperty(AddPointComponent.prototype, "longitude", {
                get: function () {
            ...
            Object.defineProperty(AddPointComponent.prototype, "order", {
                get: function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
        var PointListItemComponent = /** @class */ (function () {
            function PointListItemComponent() {
                this.remove = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
            }

            PointListItemComponent.prototype.handleRemove = function () {
                this.remove.emit();
            };
            return PointListItemComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddPointContainerComponent = /** @class */ (function () {
            function AddPointContainerComponent(store) {
                this.store = store;
            ...
            AddPointContainerComponent.prototype.handleChangePointParameters = function (value) {
                this.addPointParameters = value;
            };
            AddPointContainerComponent.prototype.handleCreate = function () {
        ...
        AddPointContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var PointListContainerComponent = /** @class */ (function () {
            function PointListContainerComponent(store) {
                this.store = store;
            ...
            PointListContainerComponent.prototype.handleRemove = function (id) {
                this.store.dispatch(new _actions_TryToRemovePointAction__WEBPACK_IMPORTED_MODULE_5__["TryToRemovePointAction"](id));
            };
            return PointListContainerComponent;
        }());
        PointListContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var PointEffects = /** @class */ (function () {
            function PointEffects(actions$, apiEndpointPointService, apiEndpointImageService, notificationService) {
                var _this = this;
                this.actions$ = actions$;
                this.apiEndpointPointService = apiEndpointPointService;
                this.apiEndpointImageService = apiEndpointImageService;
                this.notificationService = notificationService;
                this.loadPoints$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_LoadPointsAction__WEBPACK_IMPORTED_MODULE_3__["LoadPointsAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () {
                        return _this.apiEndpointPointService.getPoints().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (points) {
                            return new _actions_SetPointsAction__WEBPACK_IMPORTED_MODULE_6__["SetPointsAction"](points);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () {
                            _this.notificationService.error('Failed to load points');
                ...
                this.saveImage$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_SavePointAction__WEBPACK_IMPORTED_MODULE_14__["SavePointAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (action) {
                        return _this.apiEndpointImageService
                            .uploadImage(action.point.imgFile)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (imageUrl) {
                                return new _actions_SavePointImageFulFillAction__WEBPACK_IMPORTED_MODULE_17__["SavePointImageFulFillAction"]({
                                    pointParameters: action.point,
                                    imageUrl: imageUrl,
                                });
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () {
                                _this.notificationService.error('Failed to upload image');
                ...
                this.savePoint$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_SavePointImageFulFillAction__WEBPACK_IMPORTED_MODULE_17__["SavePointImageFulFillAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (action) {
                        return _this.apiEndpointPointService
                            .save(action.payload.pointParameters, action.payload.imageUrl)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (point) {
                                return new _actions_AddPointAction__WEBPACK_IMPORTED_MODULE_13__["AddPointAction"](point);
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () {
                                _this.notificationService.success('Failed to add point');
                                return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(new _actions_RejectSavePointAction__WEBPACK_IMPORTED_MODULE_15__["RejectSavePointAction"]());
                            }));
                    }));
                });
                this.removePoint$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_TryToRemovePointAction__WEBPACK_IMPORTED_MODULE_9__["TryToRemovePointAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (action) {
                        return _this.apiEndpointPointService.remove(action.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () {
                            return new _actions_RemovePointAction__WEBPACK_IMPORTED_MODULE_10__["RemovePointAction"](action.id);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () {
                            _this.notificationService.error('Failed to remove point');
        ...
        PointEffects.ctorParameters = function () {
            return [
                {type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"]},
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var PointsModule = /** @class */ (function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function pointReducer(state, action) {
            if (state === void 0) {
                state = _app_common_initialState__WEBPACK_IMPORTED_MODULE_2__["initialState"];
            }
            switch (action.type) {
                ...
                case _actions_AddPointAction__WEBPACK_IMPORTED_MODULE_4__["AddPointAction"].type:
                    return Object.assign({}, state, {points: state.points.concat([action.point])});
                case _actions_RemovePointAction__WEBPACK_IMPORTED_MODULE_1__["RemovePointAction"].type:
                    return Object.assign({}, state, {
                        points: state.points.filter(function (point) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/selectors/getAppState */ "./src/modules/app/selectors/getAppState.ts");
        var getPoints = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__["getAppState"], function (state) {
            return state.points;
        });
        /***/
    }),
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var AddTravelAction = /** @class */ (function () {
            function AddTravelAction(travel) {
                this.travel = travel;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var LoadTravelsAction = /** @class */ (function () {
            function LoadTravelsAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectLoadTravelsAction = /** @class */ (function () {
            function RejectLoadTravelsAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectRemoveTravel = /** @class */ (function () {
            function RejectRemoveTravel() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RejectSaveTravelAction = /** @class */ (function () {
            function RejectSaveTravelAction() {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var RemoveTravelAction = /** @class */ (function () {
            function RemoveTravelAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SaveTravelAction = /** @class */ (function () {
            function SaveTravelAction(parameters) {
                this.parameters = parameters;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SaveTravelImageFulFilledAction = /** @class */ (function () {
            function SaveTravelImageFulFilledAction(payload) {
                this.payload = payload;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var SetTravelsAction = /** @class */ (function () {
            function SetTravelsAction(travels) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
        var TryToRemoveTravelAction = /** @class */ (function () {
            function TryToRemoveTravelAction(id) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddTravelComponent = /** @class */ (function () {
            ...
            AddTravelComponent.prototype.handleChangeName = function (value) {
                this.changeTravelParameters.emit(Object.assign({}, this.addTravelParameters, {name: value}));
            };
            AddTravelComponent.prototype.handleChangeDescription = function (event) {
                var element = event.target;
                this.changeTravelParameters.emit(Object.assign({}, this.addTravelParameters, {description: element.value}));
            };
            AddTravelComponent.prototype.handleChangeCategory = function (value) {
                this.changeTravelParameters.emit(Object.assign({}, this.addTravelParameters, {categoryId: value}));
            };
            AddTravelComponent.prototype.handleChangeFile = function (file) {
                this.changeTravelParameters.emit(Object.assign({}, this.addTravelParameters, {imgUrl: [file]}));
            };
            AddTravelComponent.prototype.handleCreate = function () {
                this.create.emit();
            };
            Object.defineProperty(AddTravelComponent.prototype, "category", {
                get: function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
        var TravelListItemComponent = /** @class */ (function () {
            function TravelListItemComponent() {
                this.remove = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
            }

            TravelListItemComponent.prototype.handleRemove = function () {
                this.remove.emit();
            };
            return TravelListItemComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddTravelContainerComponent = /** @class */ (function () {
            function AddTravelContainerComponent(store) {
                var _this = this;
                this.store = store;
                this.categorySubscription = this.store
                    .pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_category_selectors_getCategories__WEBPACK_IMPORTED_MODULE_4__["getCategories"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (categories) {
                        _this.categories = categories;
                        _this.addTravelParameters = {
                            name: '',
                            imgUrl: [],
                            description: '',
            ...
            AddTravelContainerComponent.prototype.handleChangeTravelParameters = function (value) {
                this.addTravelParameters = value;
            };
            AddTravelContainerComponent.prototype.handleCreate = function () {
                this.store.dispatch(new _actions_SaveTravelAction__WEBPACK_IMPORTED_MODULE_5__["SaveTravelAction"](this.addTravelParameters));
            };
            AddTravelContainerComponent.prototype.ngOnDestroy = function () {
                this.categorySubscription.unsubscribe();
            };
            return AddTravelContainerComponent;
        }());
        AddTravelContainerComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var TravelListContainersComponent = /** @class */ (function () {
            function TravelListContainersComponent(store) {
                this.store = store;
            ...
            TravelListContainersComponent.prototype.ngOnInit = function () {
            ...
            TravelListContainersComponent.prototype.handleRemove = function (value) {
                this.store.dispatch(new _actions_TryToRemoveTravelAction__WEBPACK_IMPORTED_MODULE_4__["TryToRemoveTravelAction"](value));
            };
            return TravelListContainersComponent;
        }());
        TravelListContainersComponent.ctorParameters = function () {
            return [
                {type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var TravelEffects = /** @class */ (function () {
            function TravelEffects(actions$, apiTravelEndpointService, apiImageEndpointService, notificationService) {
                var _this = this;
                this.actions$ = actions$;
                this.apiTravelEndpointService = apiTravelEndpointService;
                this.apiImageEndpointService = apiImageEndpointService;
                this.notificationService = notificationService;
                this.loadTravels$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_LoadTravelsAction__WEBPACK_IMPORTED_MODULE_4__["LoadTravelsAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
                        return _this.apiTravelEndpointService.getTravels().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (travels) {
                            return new _actions_SetTravelsAction__WEBPACK_IMPORTED_MODULE_6__["SetTravelsAction"](travels);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
                            _this.notificationService.error('Failed to load travels');
                ...
                this.removeTravel$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_TryToRemoveTravelAction__WEBPACK_IMPORTED_MODULE_10__["TryToRemoveTravelAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (action) {
                        return _this.apiTravelEndpointService.remove(action.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
                            return new _actions_RemoveTravelAction__WEBPACK_IMPORTED_MODULE_11__["RemoveTravelAction"](action.id);
                        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
                            _this.notificationService.error('Failed to remove travel');
                ...
                this.saveImage$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_SaveTravelImageFulFilledAction__WEBPACK_IMPORTED_MODULE_16__["SaveTravelImageFulFilledAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (action) {
                        return _this.apiTravelEndpointService
                            .save(action.payload.travelParameters, action.payload.imageUrl)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (travel) {
                                _this.notificationService.success('Travel successfully added');
                                return new _actions_AddTravelAction__WEBPACK_IMPORTED_MODULE_15__["AddTravelAction"](travel);
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
                                _this.notificationService.error('Failed to save travel');
                ...
                this.saveTravel$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                    return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_SaveTravelAction__WEBPACK_IMPORTED_MODULE_13__["SaveTravelAction"].type), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (action) {
                        return _this.apiImageEndpointService
                            .uploadImage(action.parameters.imgUrl)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (url) {
                                return new _actions_SaveTravelImageFulFilledAction__WEBPACK_IMPORTED_MODULE_16__["SaveTravelImageFulFilledAction"]({
        ...
        TravelEffects.ctorParameters = function () {
            return [
                {type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"]},
        ...
        var TravelEffectsImpl = /** @class */ (function (_super) {
            __extends(TravelEffectsImpl, _super);

            function TravelEffectsImpl() {
                return _super !== null && _super.apply(this, arguments) || this;
            }

            return TravelEffectsImpl;
        }(TravelEffects));
        /***/
    }),
    /***/
        ...
        function travelReducer(state, action) {
            ...
            switch (action.type) {
                ...
                case _actions_AddTravelAction__WEBPACK_IMPORTED_MODULE_4__["AddTravelAction"].type: {
                    return Object.assign({}, state, {travels: state.travels.concat([action.travel])});
                }
                case _actions_RemoveTravelAction__WEBPACK_IMPORTED_MODULE_2__["RemoveTravelAction"].type: {
                    return Object.assign({}, state, {
                        travels: state.travels.filter(function (travel) {
                            return travel.id !== action.id;
                        })
                    });
                }
                default:
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var _app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/selectors/getAppState */ "./src/modules/app/selectors/getAppState.ts");
        var getTravels = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_app_selectors_getAppState__WEBPACK_IMPORTED_MODULE_2__["getAppState"], function (state) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var CheckboxComponent = /** @class */ (function () {
            ...
            CheckboxComponent.prototype.handleCheck = function (event, isChecked) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var ColorSchemeComponent = /** @class */ (function () {
            ...
            ColorSchemeComponent.prototype.ngOnInit = function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var DropdownComponent = /** @class */ (function () {
            ...
            DropdownComponent.prototype.handleClose = function () {
                this.onclose.emit(true);
            };
            DropdownComponent.prototype.changeDrawingDirectionIfOverlap = function () {
                var documentElement = document.documentElement;
                var domRect = this.dropdownElement.nativeElement.getBoundingClientRect();
            ...
            Object.defineProperty(DropdownComponent.prototype, "style", {
                get: function () {
                    return {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var FileUploadComponent = /** @class */ (function () {
            function FileUploadComponent(idGeneratorService) {
            ...
            FileUploadComponent.prototype.handleChange = function (event) {
                event.preventDefault();
                var element = event.target;
            ...
            FileUploadComponent.prototype.preventOpening = function (event) {
                event.preventDefault();
            };
            return FileUploadComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var InputComponent = /** @class */ (function () {
            ...
            InputComponent.prototype.toggleSelect = function () {
                this.isSelect = !this.isSelect;
            };
            InputComponent.prototype.handleInput = function (event) {
                this.oninput.emit(event.target.value);
            };
            InputComponent.prototype.handleChange = function (event) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var ModalComponent = /** @class */ (function () {
            function ModalComponent(document, modalService, element) {
            ...
            ModalComponent.prototype.handleCloseModal = function () {
                this.close();
                this.onClose.emit();
            };
            ModalComponent.prototype.hotKeyListener = function (event) {
                if (event.key === 'Escape') {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var SelectComponent = /** @class */ (function () {
            ...
            SelectComponent.prototype.handleChange = function (event) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var TabViewComponent = /** @class */ (function () {
            ...
            TabViewComponent.prototype.handleClick = function () {
                this.onSelect.emit();
            };
            return TabViewComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var TabComponent = /** @class */ (function () {
            ...
            TabComponent.prototype.handleClick = function () {
                if (!this.disabled) {
                    this.onselect.emit();
                }
            };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var TextareaComponent = /** @class */ (function () {
            ...
            TextareaComponent.prototype.handleChange = function (event) {
                this.onchange.emit(event);
            };
            TextareaComponent.prototype.handleFocus = function () {
                this.isFocus = true;
            };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var ToggleButtonComponent = /** @class */ (function () {
            function ToggleButtonComponent(render) {
                this.render = render;
                this.disabled = false;
                this.onpress = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
            }

            ToggleButtonComponent.prototype.handleClick = function () {
                if (this.disabled === true) {
                    return;
                }
            ...
            ToggleButtonComponent.prototype.moveSlider = function () {
        ...
        ToggleButtonComponent.ctorParameters = function () {
            return [
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var TooltipComponent = /** @class */ (function () {
            function TooltipComponent(elementReference) {
                this.elementReference = elementReference;
                this.offsetX = 0;
                this.offsetY = 0;
            }

            Object.defineProperty(TooltipComponent.prototype, "transform", {
                get: function () {
                    var height = this.elementReference.nativeElement.offsetHeight;
